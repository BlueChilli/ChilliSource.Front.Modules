...
interface SelectMessages {
	 ...
	 */
	open?: string | ((props: SelectProps) => string);
	/**
	 * The placeholder text for the filter input.
	 */
	filterPlaceholder?: string | ((props: SelectProps) => string);
	/**
	 * Text to display when the data prop array is empty.
	 * @default: "There are no items in this list"
	 */
	emptyList?: string | ((props: SelectProps) => string);
	/**
	 * Text to display when the the current filter does not return any results.
	 * @default: "The filter returned no results"
	 */
	emptyFilter?: string | ((props: SelectProps) => string);
	/**
	 * Text to display for the create option
	 * @default: "Create option {text}"
	 */
	createOption?: string | ((props: SelectProps) => string);
}
