...
/** Components */
import { FormGenerator, InputMapper, Row, Col, showAlert, Modal, toggleModal } from '../../../Frecl/exports';
import { Input } from 'cs.forms';


const Manage = ({
  preferences, changeEmail, changePassword, createToggleModal,
}) => (
  <div>
    <h1>My Account</h1>
...
const mapDispatchToProps = dispatch => ({
  changePassword: () => {
    ...
    dispatch(showAlert('success', null, 'Your password has been changed successfully'));
  },

  changeEmail: () => {
    dispatch(toggleModal('emailModal'));
    dispatch(createEasyNotification('success', null, 'Your email has been modified successfully.'));
  },
