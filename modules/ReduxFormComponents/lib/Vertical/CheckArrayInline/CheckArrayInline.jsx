...
class CheckArrayInline extends React.Component {
  ...
  render() {
    ...
    return (
      <FormElementWrapper {...this.props} _id="fe-checkarray-inline">
        {label &&
        ...
        <div className="form-input">
          ...
          {this.props.options.map(option => {
            ...
            return (
              <div key={option.id} className="checkbox checkbox-inline">
                <input
                  {...input}
...
export default CheckArrayInline;