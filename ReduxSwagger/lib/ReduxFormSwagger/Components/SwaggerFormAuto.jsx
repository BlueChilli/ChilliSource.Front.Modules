...
import {
  getBodyParamsFromOperation, getByOperationId, getSummaryArrayByOperationId,
  getFormDataParamsFromOperation
} from "../data/swaggerReaderUtils";
import guessFieldType from "../data/guessFieldType";
import TextField from "../Components/Vertical/TextField/TextField";
...
const SwaggerField = ({data}) => {
  const fieldType = guessFieldType(data);
