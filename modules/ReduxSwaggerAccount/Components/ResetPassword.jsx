...
import {
	...
	SwaggerForm,
	swaggerLoader,
} from '../../ReduxSwagger/lib/ReduxFormSwagger/index';
import { createSession } from '../actions';
import HiddenField from '../../FormComponents/lib/Vertical/HiddenField/HiddenField';
...
import matchPassword from '../../FormComponents/lib/validators/matchPassword';
...
class Invite extends React.Component {
	render() {
		...
		return (
			<SwaggerData
				id="get/api/v1/useraccount/bytoken"
				data={{ email: Email, token: Token }}
				onError={() => <TokenProblem />}
				debug={true}>
				{context => {
					...
					return (
						<div>
							...
							<SwaggerForm
								...
								id="patch/api/v1/useraccount/bytoken"
...
const InfoElement = ({ label, data }) => {
	return (
		<div className="form-element">
			...
			<div className="form-input">{data}</div>
		</div>
	);
};
...
const TokenProblem = () => (
	<div>
		<h1>Error</h1>
		<p style={{ color: 'red' }}>
			You can no longer reset your password using this address. You will need to{' '}
			<Link to="/account/resetPasswordInit">reset your password again</Link>
		</p>
	</div>
);
