...
storiesOf('Validations', module)
  ...
  .add('Everything', () => (
    <div>
      <Field label="Required" name="textFldRequired" component={TextField} validate={required}/>
      <Field label="Birthday" name="birthday" dateFormat="DD/MM/YYYY" component={DatePicker} validate={required}/>
      <Field label="this must be ticked" name="isAwesome" component={SimpleCheck} validate={ticked}/>
    </div>
  ));
